...
def move_rob(adj_Mat,num_Nodes,num_Edges,a,b,c,d):
	...
	for sol in sols:
		...
		x_rob.append(rob_pos)
		nodes1.append(sol[:ROB1_POS_INDEX])
		nodes2.append(sol[ROB1_POS_INDEX+1:ROB2_POS_INDEX])
		sensorvals.append([fn_s(rob_pos[0]%1,0,rob_pos),fn_s(rob_pos[1]%1,1,rob_pos)])
		
		rob_dist = 1 if min(abs(rob_pos[0]-rob_pos[1]),1-abs(rob_pos[0]-rob_pos[1])) < 0.1 else 0
	...
	return (score,x_rob,nodes1,nodes2,hands,t_rob,sensorvals,fixed_sensor_pos,agent_shadow_rel_pos)